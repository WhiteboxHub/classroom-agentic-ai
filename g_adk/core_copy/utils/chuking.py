...
class FolderFileReader:
    ...
    def read_folder(self) -> List[Tuple[str, str]]:
        ...
        a list of (filename, extracted_text).
        """
        results = []
        ...
        for filename in os.listdir(self.folder_path):
            ...
            if ext == ".pdf":
                results.append((filename, self.read_pdf(file_path)))

            elif ext == ".docx":
                results.append((filename, self.read_word(file_path)))

            elif ext == ".txt":
                results.append((filename, self.read_txt(file_path)))
